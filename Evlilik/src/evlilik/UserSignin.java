...
public class UserSignin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String womann_id=WomanIdText.getText();
        ...
        try{
            ...
            ResultSet rs=st.executeQuery("SELECT *FROM users WHERE man_id='"+man_id+"'AND woman_id='"+womann_id+"'");
            while(rs.next()){
                count++;
            }
            if(count==0){
                ...
                pre.setString(1, manNameText.getText());
                pre.setString(2, WomanNameText.getText());
                pre.setString(3, manSurnameText.getText());
                pre.setString(4, WomanSurnameText.getText());
                pre.setInt(5, manAge);
                pre.setInt(6, womanAge);
                pre.setString(7, manCityText.getText());
                pre.setString(8, WomanCityText.getText());
                pre.setString(9, emailText.getText());
                pre.setString(10, password);
                pre.setString(11, man_id);
                pre.setString(12, womann_id);
                pre.executeUpdate();
            }
            key=1;
